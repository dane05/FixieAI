...
const App = () => {
  ...
  const handleSend = () => {
    ...
    if (teachMode && tempProblem) {
      ...
      setDoc(doc(db, "chatbotKnowledge", tempProblem.toLowerCase()), knowledge);
    ...
    const response = match ? match.solution || match.text : "Sorry, I don't know that yet.";
    setTimeout(() => {
  ...
  const handleSend = async () => {
    ...
    if (match) {
      ...
      try {
        ...
        // Optional: Prompt user to save this AI answer for future use
        // You can offer a "Save this?" button here
